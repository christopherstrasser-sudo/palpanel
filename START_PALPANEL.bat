...
echo Insights:  http://localhost:8787/admin/insights
...
echo Raids:     http://localhost:8787/admin/raids
...
echo IngameMods:Serverseitige UE4SS-Aktionen aktiv
echo Raids:     Dynamische Boss-Raids + Teilnahme + Loot + Kartenmarker aktiv
...
echo.
node -r ./src/frontend-routeguard.js -r ./src/fast-process-shim.js src\server-v0914.js
echo.
